!function (e, t, n) {
    ...
    !function o(e, t, n) {
        ...
        1: [function (o, a) {
            ...
            }, c = o("./modules/handle-dom"), d = o("./modules/utils"), f = o("./modules/handle-swal-dom"), p = o("./modules/handle-click"), m = o("./modules/handle-key"), v = u(m), y = o("./modules/default-params"), h = u(y), g = o("./modules/set-params"), b = u(g);
            l = i = function () {
                function o(e) {
                    var t = a;
                ...
                }, w = 0; w < m.length; w++)for (var C = 0; C < y.length; C++) {
                    var S = y[C];
                    m[w][S] = g
                }
